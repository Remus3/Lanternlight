...
| [ADR-007](ADR-007-lane-slot-root-is-ours.md) | Lanternlight takes a lane slot, with the lock root in this repo | Superseded by ADR-008 |
| [ADR-008](ADR-008-join-the-shared-bucket.md) | Join the shared lane-slot bucket, surplus-only until the reserved widening lands | Accepted |
