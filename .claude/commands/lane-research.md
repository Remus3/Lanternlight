---
description: Research and provenance lane. Own the measured record and the class reference. Writes no code. Every claim carries its source and its trust tier, and a measured null is a result worth writing down.
---
...
# Lane `research` - Research and provenance

## Mandate

Own the measured record and the class reference. Writes no code. Every claim carries its source and its trust tier, and a measured null is a result worth writing down.

## Your workspace

Your working directory is your own worktree, **`ll-lane-research`**
under the worktree root, on branch **`lane/research`**. The worktree
...
Commit and push to **`lane/research`** freely. **Never merge to `main`**, never
